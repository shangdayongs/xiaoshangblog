...
- 在线练习 
   - ⭐ 小尚的闯关式 SQL 自学网：[http://sqlmother.yupi.icu/](http://sqlmother.yupi.icu/)
...
学习完框架后，即可跟着小尚的原创项目教程系列边学边做项目。用项目驱动学习，更快地掌握后端必学技术，并直接写在简历上：[项目实战 - 小尚原创项目教程系列](https://yuyuanweb.feishu.cn/wiki/SePYwTc9tipQiCktw7Uc7kujnCd) 。
...
### 🌘 前端基础（14 天）
详情请参考小尚原创的前端学习路线：[https://mp.weixin.qq.com/s/HbzLEt6NOP9Is9F3GOnbUQ](https://mp.weixin.qq.com/s/HbzLEt6NOP9Is9F3GOnbUQ)
...
### 练手项目
推荐跟着小尚的原创项目教程系列边学边做项目，每个项目都是前端 + 后端的全栈项目。用项目驱动学习，更快掌握前端基础和后端必学技术，并直接写在简历上：[项目实战 - 小尚原创项目教程系列](https://yuyuanweb.feishu.cn/wiki/SePYwTc9tipQiCktw7Uc7kujnCd) 。
...
此外，小尚改了几百份简历，基本上没有同学把设计模式写在项目经历中。因此学好设计模式并写在简历上是很加分的！
...
- 项目
   - [项目实战 - 小尚原创项目教程系列](https://yuyuanweb.feishu.cn/wiki/SePYwTc9tipQiCktw7Uc7kujnCd) 中的聚合搜索项目、OJ 项目都运用了大量的设计模式，推荐学习
-  书籍 
...
- 项目
   - [项目实战 - 小尚原创项目教程系列](https://yuyuanweb.feishu.cn/wiki/SePYwTc9tipQiCktw7Uc7kujnCd) 中的伙伴匹配系统、智能 BI 项目都运用了 Redis 解决实际问题，推荐学习
- 视频 
...
- 项目
   - [项目实战 - 小尚原创项目教程系列](https://yuyuanweb.feishu.cn/wiki/SePYwTc9tipQiCktw7Uc7kujnCd) 中的智能 BI 项目、在线判题系统都运用了消息队列解决实际问题，推荐学习
- 视频 
...
- 视频 
   ...
   - ⭐ Nginx 小尚 - 手把手带你从0搭建个人网站：[https://www.bilibili.com/video/BV1rU4y1J785/](https://www.bilibili.com/video/BV1rU4y1J785/) （简单演示 Nginx 部署网站）
- 文档 
...
- 项目实战
   - [项目实战 - 小尚原创项目教程系列](https://yuyuanweb.feishu.cn/wiki/SePYwTc9tipQiCktw7Uc7kujnCd) 中的 API 开放平台、在线判题系统都运用了微服务，推荐学习 
- 视频 
...
- 项目实战
   - [项目实战 - 小尚原创项目教程系列](https://yuyuanweb.feishu.cn/wiki/SePYwTc9tipQiCktw7Uc7kujnCd) 中的在线判题项目运用了 Docker 解决实际问题，推荐学习 
- 视频 
...
-  实战平台 
   - ⭐ 微信云托管：[https://cloud.weixin.qq.com/cloudrun](https://cloud.weixin.qq.com/cloudrun) （直播演示过，小尚后面会给大家出视频教程）
   - 前端托管 Webify：[https://cloud.tencent.com/product/webify](https://cloud.tencent.com/product/webify) （小尚给大家出过视频教程的 https://www.bilibili.com/video/BV11V411p7vf/）
...
1. ⭐️ 小尚全程直播带做的保姆级全栈项目，带现成的简历写法和面试题：[项目实战 - 小尚原创项目教程系列](https://yuyuanweb.feishu.cn/wiki/SePYwTc9tipQiCktw7Uc7kujnCd)。
...
- [项目实战 - 小尚原创项目教程系列](https://yuyuanweb.feishu.cn/wiki/SePYwTc9tipQiCktw7Uc7kujnCd)
- SQL 数据生成器（React + Java）：[https://github.com/shangdayongs/sql-father-frontend-public](https://github.com/shangdayongs/sql-father-frontend-public)
- 结构化 SQL 语句生成器：[https://github.com/shangdayongs/sql-generator](https://github.com/shangdayongs/sql-generator)
- AI 自动回复工具（Java 项目）：[https://github.com/shangdayongs/yu-auto-reply](https://github.com/shangdayongs/yu-auto-reply)
- 表情包网站（Vue + Java）：[https://github.com/shangdayongs/father](https://github.com/shangdayongs/father)
...
- 项目实战
   - [项目实战 - 小尚原创项目教程系列](https://yuyuanweb.feishu.cn/wiki/SePYwTc9tipQiCktw7Uc7kujnCd) 中的伙伴匹配系统、智能 BI 项目、OJ 判题系统都运用了并发编程解决实际问题，推荐学习 
- 视频 
